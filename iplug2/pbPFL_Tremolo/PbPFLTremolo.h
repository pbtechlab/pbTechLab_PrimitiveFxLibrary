...
class PbPFLTremolo final : public Plugin
{
public:
  PbPFLTremolo(const InstanceInfo& info);
...
private:
  // One-pole smoothing identical to PrimitiveFxProcessor::smooth().
  static inline float Smooth(float current, float target, float coeff)
  {

...
// original JUCE Flanger, so the ported algorithm is sample-faithful.
...
class PbPFLFlanger final : public Plugin
{
public:
  PbPFLFlanger(const InstanceInfo& info);

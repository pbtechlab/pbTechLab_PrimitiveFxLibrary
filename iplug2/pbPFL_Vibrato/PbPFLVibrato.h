...
// original JUCE Vibrato (modulationDelay), so the ported algorithm is sample-faithful.
...
class PbPFLVibrato final : public Plugin
{
public:
  PbPFLVibrato(const InstanceInfo& info);
